...
<ScrollView style={{flex: 1, paddingHorizontal: 15}}>
            ...
            marginVertical: 20}}>Viagens que você marcou</Text>
                        <FlatList data={trips.concat(data)} renderItem={(item) => {
                        console.log('data', item.item.data?.car?.notice)
                        if (item.item?.data){
                            
                           if (item.item.data?.car?.notice){
                            console.log(item.item.data.car.imagens)
                            return (
                                ...
                                navigation.dispatch(StackActions.push('tripInfo', {
                                  ...
                                  <View style={styles.container}>
                                      <View style={{width: 65,
                                          ...
                                          <Image source={{uri: `${baseURL}media/${item.item.data.car.imagem}`}} style={styles.image}/>
                                      </View>
